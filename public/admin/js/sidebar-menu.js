  ...
  // left sidebar and horizotal menu
    if($('#pageWrapper').hasClass('compact-wrapper')){
          ...
          jQuery('.menu-title').append('<div class="according-menu"></i></div>');
          jQuery('.menu-title').click(function () {
              jQuery('.menu-title').removeClass('active');
              jQuery('.menu-title').find('div').replaceWith('<div class="according-menu"></i></div>');
              jQuery('.menu-content').slideUp('normal');
              if (jQuery(this).next().is(':hidden') == true) {
                  jQuery(this).addClass('active');
                  jQuery(this).find('div').replaceWith('<div class="according-menu"></i></div>');
                  jQuery(this).next().slideDown('normal');
              } else {
