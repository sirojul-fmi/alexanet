...
<div class="container-fluid">
  <div class="page-header">
    <h3>List Pesan Pengajuan Berhenti</h3>
    <ol class="breadcrumb">
                      ...
                      <div class="modal-dialog modal-dialog-centered modal-lg modal-dialog-scrollable">
                        <div class="modal-content">
                          ...
                          <div class="modal-body">
                            <form action="<?=base_url()?>admin/pesan/konfirmasi/stop" method="post">
                              <div class="row">
                                ...
                                <div class="col-lg-12 col-sm-12">
                                  ...
                                  <button type="submit" class="btn btn-primary btn-sm mt-3">Konfirmasi Pengajuan Berhenti</button>
                                </div>
                              </div>
                            </form>
                          </div>
