...
<?= $this->section('title'); ?>
<title>Edit Rules | Alexanet</title>
<?= $this->endSection() ?>
...
<div class="container-fluid">
  <div class="row">
    <div class="col-sm-12">
      <div class="card">
        <form action="<?=base_url()?>admin/rules/update" method="POST" class="theme-form">
          <div class="card-body">
            <div class="mb-3" hidden>
              <label for="rulesId" class="col-form-label">Rules Id</label>
              <input type="text" name="rulesId" class="form-control" id="rulesId" value="<?=$rules['id']?>" readonly>
            </div>
            <div class="mb-3">
              ...
              <select name="lokasi" id="lokasi" class="form-control">
                ...
                <option value="<?=$data['premis_code']?>" <?=($data['premis_code']==$rules['rule1']) ? 'selected' : ''?>><?=$data['premis']?></option>
                <?php endforeach; ?>
              </select>
            </div>
            <div class="mb-3">
              ...
              <select name="perangkat" id="perangkat" class="form-control">
                ...
                <option value="<?=$data['premis_code']?>" <?=($data['premis_code']==$rules['rule2']) ? 'selected' : ''?>><?=$data['premis']?></option>
                <?php endforeach; ?>
              </select>
            </div>
            <div class="mb-3">
              ...
              <div class="row">
                <div class="col-lg-6 col-sm12">
                  <select name="jangkauan1" id="jangkauan1" class="form-control">
                    ...
                    <option value="<?=$data['premis_code']?>" <?=($data['premis_code']==$rules['rule3']) ? 'selected' : ''?>><?=$data['premis']?></option>
                    <?php endforeach; ?>
                  </select>
                </div>
                <div class="col-lg-6 col-sm12">
                  <select name="jangkauan2" id="jangkauan2" class="form-control">
                    ...
                    <option value="<?=$data['premis_code']?>" <?=($data['premis_code']==$rules['rule4']) ? 'selected' : ''?>><?=$data['premis']?></option>
                    <?php endforeach; ?>
                  </select>
                </div>
              </div>
              <div class="mb-3">
                ...
                <select name="kesimpulan" id="kesimpulan" class="form-control">
                  ...
                  <option value="<?=$data['packet_code']?>" <?=($data['packet_code']==$rules['conclusion']) ? 'selected' : ''?>><?=$data['packet']?></option>
                  <?php endforeach; ?>
                </select>
              </div>
            </div>
